...
def _check_sensitive_path(filepath: str, task_id: str = "default") -> str | None:
    ...
    # Check the exact Hermes config path before generic system prefixes. On
    # macOS, pytest and other isolated homes commonly resolve through
    # /private/var; callers should still receive the actionable config guard.
